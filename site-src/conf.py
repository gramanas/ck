...
BLOG_AUTHOR = "gramanas"  # (translatable)
BLOG_TITLE = "ck - the config keeper"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://gramanas.github.io/ck/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://ck.github.io/"
BLOG_EMAIL = "anastasis.gramm2@gmail.com"
BLOG_DESCRIPTION = "ck - the config keeper"  # (translatable)
...
DISABLED_PLUGINS = ['classify_indexes', 'classify_sections', 'classify_page_index', 'robots']
